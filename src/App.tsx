...
export const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzyrNrnLY6F3PyMVWck71-vL9hZ7q5CSsmq1me64ZY-MpoIxon3wUk5T3vcsV250P3ofQ/exec";
          ...
          <header className="flex flex-col items-center mb-12 sm:mb-20 w-full select-none">
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12">
              ...
              <div className="text-center">
                <span className="block text-xs sm:text-sm md:text-base font-black tracking-[0.3em] text-emerald-400 mb-1 sm:mb-2 uppercase">
                  HAVA ARAÇLARI
                </span>
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tighter leading-none text-white text-shadow uppercase">
                  BAKIM VE TEKNİK
                </h1>
              </div>
        ...
        <div className="flex-1 w-full bg-[#f8fafc] relative overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-slate-950 flex flex-col overflow-hidden text-white animate-fade-in z-20">
                        ...
                        <div className="flex-1 overflow-auto p-6 md:p-8 flex justify-center bg-slate-950 scrollbar-thin">
                          <div className="w-full max-w-7xl bg-white text-slate-800 rounded-[1.5rem] shadow-2xl p-8 flex flex-col border border-slate-200 select-text relative overflow-x-auto min-w-[1000px]">
                            ...
                            {/* Column Headers */}
                            <div className="flex-1 overflow-x-auto scrollbar-thin flex flex-col">
                              <div className="min-w-[1310px] flex-1 flex flex-col">
                                <div className="grid grid-cols-[60px_160px_110px_80px_100px_90px_90px_110px_70px_180px_140px_120px] gap-2 bg-slate-900 text-white rounded-xl p-3 text-center text-[10px] font-extrabold uppercase tracking-wider mb-2 select-none">
                                  <div>SIRA NO</div>
                                  <div>ADI SOYADI</div>
                                  <div>T.C. KİMLİK</div>
                                  <div>SİCİL NO</div>
                                ...
                                {/* 537 Rows Layout container. Vertically scrollable only */}
                                <div className="flex-1 space-y-1.5 max-h-[60vh] overflow-y-auto pr-2 scrollbar-thin">
                              {(() => {
                                const q = excelSearchQuery.toLowerCase().trim();
          ...
          {modalType === 'techizat_matrix' && activeTechizatType && (() => {
            const cols = activeTechizatType === 'all'
              ? ["BİRİM / HAVA ARACI", "SIRA NO", "TEÇHİZAT ADI", "PARÇA NO (P/N) / MODEL", "SERİ NO (S/N)", "MİKTAR / KAPASİTE", "BULUNDUĞU YER", "DURUMU", "SON KONTROL / BAKIM", "GELECEK KONTROL / BAKIM", "SON KONTROLÜ YAPAN FİRMA", "AÇIKLAMA"]
              : activeTechizatType === 'bell429' ? techizatBell429Columns
              : activeTechizatType === 'at802' ? techizatAt802Columns
              : activeTechizatType === 't70' ? techizatT70Columns
              : activeTechizatType === 't70_bumbi_backet' ? techizatT70BumbiBacketColumns
              : activeTechizatType === 'b360' ? techizatB360Columns
              : activeTechizatType === 'c650' ? techizatC650Columns
              : techizatHangarColumns;
            ...
            return (
              <div className="absolute inset-0 flex flex-col bg-slate-50 p-4 md:p-6 lg:p-8 animate-fade-in overflow-y-auto">
                <div className="max-w-7xl mx-auto w-full flex flex-col h-full">
                  ...
                  <div className="bg-slate-900 text-slate-200 rounded-3xl p-5 mb-6 flex flex-col md:flex-row gap-4 items-center justify-between shadow-xl border border-slate-800 print:hidden select-none">
                    <div className="flex items-center gap-3 w-full md:w-auto">
                      ...
                      <div className="relative flex-1 md:flex-initial">
                        <input
                          ...
                          className="bg-slate-800 text-white font-extrabold text-xs px-4 py-3 rounded-2xl focus:outline-none focus:ring-4 focus:ring-emerald-500/20 w-full md:w-72 border border-slate-700 placeholder-slate-400"
                        />
                      </div>
                      {techizatSearchQuery && (
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto justify-end">
                      ...
                      {activeTechizatType !== 'all' && (
                        <button
                          ...
                          className="px-4 py-3 bg-[#0b3d1d] hover:bg-[#072612] active:scale-95 text-white font-black font-mono text-xs rounded-2xl flex items-center gap-2 transition-all cursor-pointer shadow-lg border border-emerald-600"
                        >
                      ...
                      <button
                        ...
                        className="px-4 py-3 bg-emerald-700 hover:bg-emerald-600 active:scale-95 text-white font-black font-mono text-xs rounded-2xl flex items-center gap-2 transition-all cursor-pointer shadow-lg shadow-emerald-900/10 border border-emerald-600"
                      >
                      ...
                      <button
                        ...
                        className="px-4 py-3 bg-indigo-700 hover:bg-indigo-600 active:scale-95 text-white font-black font-mono text-xs rounded-2xl flex items-center gap-2 transition-all cursor-pointer shadow-lg shadow-indigo-900/10 border border-indigo-600"
                      >
                  ...
                  <div className="flex-1 bg-white border-2 border-slate-200/60 rounded-[2.5rem] shadow-xl overflow-hidden flex flex-col print:border-none print:shadow-none min-h-[400px]">
                    ...
                    <div className="bg-slate-900 px-6 py-4 border-b border-slate-800 flex items-center justify-between select-none print:hidden shrink-0">
                      ...
                      <span className="text-[10px] font-mono font-black text-slate-400 bg-slate-800 px-3 py-1 rounded-full border border-slate-700">
                        {rows.length} KALEM TEÇHİZAT KAYITLI
                      </span>
                    </div>
                    ...
                    <div className="w-full text-black bg-white min-h-screen">
                      ...
                      <table className="w-full border-collapse border border-slate-300 text-[10px]">
                        <thead>
                          <tr className="bg-[#0b3d1d] text-white font-bold text-[9px]">
                            {cols.map((col, idx) => (
                              <th key={idx} className="border border-slate-300 p-2 bg-[#0b3d1d] text-white text-center uppercase font-mono">{col}</th>
                            ))}
                          </tr>
                        </thead>
                        <tbody>
                          {rows.map((row, rIdx) => (
                            <tr key={rIdx} className={rIdx % 2 === 1 ? "bg-slate-50" : "bg-white"}>
                              {row.map((cell, cIdx) => (
                                <td key={cIdx} className="border border-slate-300 p-2 text-center text-slate-900 font-bold">{cell || "-"}</td>
                              ))}
                            </tr>
                          ))}
                        </tbody>
